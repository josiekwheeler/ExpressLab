...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.updateItem = function (newid, oldid) {
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.updateAnItem = function (newid, oldid) {
        var _this = this;
        this.apiService.updateItem(newid, oldid).subscribe(function (response) {
            _this.cartitems = response;
        });
    };
...
module.exports = __webpack_require__(/*! /Users/josiekwheeler/Documents/expressLab/src/main.ts */"./src/main.ts");
